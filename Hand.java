...
public class Hand implements Comparable<Hand>
{
	...
	//Random generator
	private My_Best_Random_Generator generator = new My_Best_Random_Generator();
	 ...
	 */
	public Hand[] getTwoRandomHands(Hand h1, Hand h2, int h1c1, int h1c2, int h2c1, int h2c2)
	{
		...
		h1.insertSevenCards(h1c1, h1c2, generator.next_int(52), generator.next_int(52), generator.next_int(52), generator.next_int(52), generator.next_int(52));
		h2.insertSevenCards(h2c1, h2c2, generator.next_int(52), generator.next_int(52), generator.next_int(52), generator.next_int(52), generator.next_int(52));
	...
	{
		int result = this.determineRank().compareTo(other.determineRank()); 
