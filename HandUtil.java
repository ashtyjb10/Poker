...
{	
	...
	{	
		...
		if(isThreeOfAKind(hand))
		{
			...
			if(hand.length == 7)
			{
//				if(hand[middle].value == hand[middle])
		...
		//Seven cards implementation 
//		if(hand.length == 7)
//		{
//			for(int index = hand.length - 2; index > 0; index--)
//			{				
//				//Checking for three of a kind
//				if(hand[index].value != hand[index - 1].value && hand[index].value != hand[index + 1].value)
//				{
//					numThreeOfAKind++;
//					
//					int marker = index - 1;
...
//					int iterIdx = 1;
//					
//					while(iterIdx < marker)
//					{
//						if(hand[iterIdx].value == hand[iterIdx - 1].value)
//						{
//							numPair++;
//						}
//						
...
//			}
//			
//			if(numPair >= 1 && numThreeOfAKind >= 1)
//			{
//				return true;
//			}
//			
